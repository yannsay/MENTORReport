...
namesDiarrhea <- c("Total Diarrhées pour < 5 ans", "Total Diarrhées pour > 5 ans", "Total Diarrhées", "Total ORS distribués", "Total Patients ayant reçu ORS", "Nb de patients avec diarrhée ayant reçu ORS", "% de patients avec diarrhée traités correctement")
